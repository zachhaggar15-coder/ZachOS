    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Neither rule-following structuralism nor rational choice resembles how people actually act" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It tracks class position closely while being experienced as the most personal thing about you" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It rewards a habitus distributed before anyone started, then calls the result talent" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It is a static background condition producing deaths diffusely across statistics" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It is partly true individually and dissolves the pattern, so no structure needs explaining" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Explaining outcomes by proximate behaviour while ignoring the structure constraining it" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Without naming a mechanism it substitutes moral posture for analysis and cannot be tested" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Society is the precarious effect of associations, so invoking it explains by the thing needing explanation" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Describing humans and non-humans in the same terms without granting either priority" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Symmetry is methodological, not metaphysical — it stops you overlooking what produces the effect" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "An obligation built into a device enforces itself and stops looking like a choice" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The flattening that enables symmetry removes the vocabulary for describing power and inequality" },
