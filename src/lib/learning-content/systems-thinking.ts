    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Early leads amplify themselves, so the system selects for whatever led rather than for quality" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Complementary assets — the skills, tools and processes built around the standard" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The evidence for Dvorak's superiority is thin, so QWERTY may be a standard rather than a failure" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Intervention is nearly free during an early open window and nearly impossible after lock-in" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Each is rational given what everyone else does, which is precisely why nobody defects" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "A regulator needs at least as many distinct responses as there are distinct disturbances" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The excluded variety does not vanish but is displaced onto whoever lives with the exclusion" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Discretion is variety amplification, so removing it drops the organisation below the environment" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It needs variety only on the dimension it regulates, not across the room's full complexity" },
