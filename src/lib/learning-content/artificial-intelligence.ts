    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Sequential dependency prevented parallel training on hardware built for parallelism" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A weighted sum of all values, with weights from query-key compatibility" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Attention is permutation-invariant, so nothing in it knows about token order" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It made the scaling experiment possible; parallelism meeting hardware did the work, not insight about language" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "It was drawn from the same pool, so it shares whatever biases the collection introduced" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "In concept drift the input-to-label relationship itself changes, not just the inputs" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Patrols find crime where they are sent, confirming the prediction and validating a world the model created" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Nothing in the architecture represents unfamiliarity, so accuracy falls while confidence stays high" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Continuous monitoring of inputs and performance, treating the model as a perishable claim" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "They are generated by the same process as the answer and optimised for plausibility, not accuracy" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A circuit implementing 'find where this token appeared before and predict what followed'" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "More features than dimensions can be packed into overlapping directions when features are sparse" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It only covers inputs you tried, and is defeated by anything that behaves differently under evaluation" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "They may produce plausible stories as confabulated as the model's own explanations" },
