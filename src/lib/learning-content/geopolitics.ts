...
const geopolitics: AuthoredLesson[] = [
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Railways, restoring land transport against ships" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The Rimland — Eurasia's coastal belt" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Ring the periphery to deny the interior the coasts" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Shipping stayed cheaper, so the interior lagged" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "They cast passing tech conditions as fixed laws" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Land a power owns and governs outright" },
          { id: "b", label: "Where a power expects privileged sway" },
          { id: "c", label: "A formal international organisation" },
          { id: "d", label: "A particular kind of trade pact" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The Americas as a US sphere, warning Europe" },
          { id: "b", label: "That the US meant to annex Europe" },
          { id: "c", label: "That the US cared nothing for its neighbours" },
          { id: "d", label: "A sweeping free-trade zone with Asia" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A curb on choosing allies" },
          { id: "b", label: "As a promise of full independence" },
          { id: "c", label: "As having no bearing on its choices" },
          { id: "d", label: "As outright ownership by another state" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "They clash with sovereign equality" },
          { id: "b", label: "Because discussing them is forbidden" },
          { id: "c", label: "Because they belong only to the past" },
          { id: "d", label: "Because great powers wholly reject them" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Powers want a cushion from rivals" },
          { id: "b", label: "Because small states demand them" },
          { id: "c", label: "Because they carry no security logic" },
          { id: "d", label: "Because international law demands them" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Holding the world's largest oil reserves" },
          { id: "b", label: "Reliable, affordable, resilient energy" },
          { id: "c", label: "Relying solely on renewable power" },
          { id: "d", label: "Fixing energy prices forever" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Reliance invites cut-offs and coercion" },
          { id: "b", label: "Because imports always cost more" },
          { id: "c", label: "Because home energy cannot be used" },
          { id: "d", label: "Because dependence carries no politics" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Cheap energy, unreliable supplier, high cost" },
          { id: "b", label: "That gas is needless for modern economies" },
          { id: "c", label: "That dependence is perfectly safe" },
          { id: "d", label: "That energy and conflict never connect" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Many suppliers, so none can coerce" },
          { id: "b", label: "Because one supplier is cheapest and safest" },
          { id: "c", label: "Because it locks in the lowest price" },
          { id: "d", label: "Because it ends the need for imports" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A supplier can cut supply to coerce" },
          { id: "b", label: "By rendering energy physically explosive" },
          { id: "c", label: "Energy has no political use" },
          { id: "d", label: "By importers alone, never exporters" },
        ],
        correctChoiceId: "a",
  ...
  },
  {
    ...
    keyTerms: [
      { label: "Buffer state", value: "A state cushioning two rivals." },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "A rich country with a large army" },
          { id: "b", label: "A state cushioning two rivals" },
          { id: "c", label: "A country that borders no one" },
          { id: "d", label: "A formal international organisation" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Its location is its value and its fate" },
          { id: "b", label: "Because geography does not touch politics" },
          { id: "c", label: "Because buffer states are the strongest" },
          { id: "d", label: "Because they can simply relocate" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Shielded by rivalry, or crushed by it" },
          { id: "b", label: "It is always perfectly safe" },
          { id: "c", label: "It always grows into a great power" },
          { id: "d", label: "It carries no strategic weight" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It lasts only while powers allow it" },
          { id: "b", label: "Because neutrality breaks the law" },
          { id: "c", label: "Because neutral states lack governments" },
          { id: "d", label: "Because it always ensures safety" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A power fears losing its buffer" },
          { id: "b", label: "Alignment never troubles great powers" },
          { id: "c", label: "Buffer states have vanished entirely" },
          { id: "d", label: "Economics alone explains such crises" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "A purely symbolic gesture with no effect" },
          { id: "b", label: "Between words and war, pressure without arms" },
          { id: "c", label: "A disguised form of military invasion" },
          { id: "d", label: "A tool used only among allies" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Targets evade and regimes bear the pain" },
          { id: "b", label: "Because sanctions are never truly imposed" },
          { id: "c", label: "Because they always bite at once" },
          { id: "d", label: "Because targets lack any economy" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "They hit the public; elites are shielded" },
          { id: "b", label: "They are far too gentle on all" },
          { id: "c", label: "They strike only the sanctioning state" },
          { id: "d", label: "They carry no humanitarian cost" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Hit named targets, spare ordinary people" },
          { id: "b", label: "Sanction the whole world economy at once" },
          { id: "c", label: "Swap sanctions for military force" },
          { id: "d", label: "Quietly reward the targeted regime" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "To signal resolve and impose lasting costs" },
          { id: "b", label: "Almost entirely by accident" },
          { id: "c", label: "Because coercion is their only purpose" },
          { id: "d", label: "To bolster the targeted regime" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "The length of a country's coastline" },
          { id: "b", label: "Using the sea, and denying it to rivals" },
          { id: "c", label: "The size of a nation's fish catch" },
          { id: "d", label: "Legal ownership of the seabed" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Sea transport is cheap, and most trade goes by sea" },
          { id: "b", label: "Because the seabed holds most of the world's wealth" },
          { id: "c", label: "Because land routes are unusable" },
          { id: "d", label: "Because the sea is easy to own outright" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Command of the sea makes nations great" },
          { id: "b", label: "That navies had become obsolete" },
          { id: "c", label: "That land armies alone mattered" },
          { id: "d", label: "That trade should shun the sea" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Hold the straits and you throttle trade" },
          { id: "b", label: "Because chokepoints are unrelated to the sea" },
          { id: "c", label: "Because navies shun narrow waters" },
          { id: "d", label: "Because trade never passes straits" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Much trade passes; control is fought" },
          { id: "b", label: "It bears no shipping whatever" },
          { id: "c", label: "It matters nothing to world trade" },
          { id: "d", label: "It is completely landlocked" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Resource-rich countries exhaust reserves fast" },
          { id: "b", label: "Rich-in-resources often means worse off" },
          { id: "c", label: "A treaty banning resource exports" },
          { id: "d", label: "The idea that natural wealth ensures prosperity" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A boom lifts the currency; exports wither" },
          { id: "b", label: "It cures the economy of every ill" },
          { id: "c", label: "It makes manufacturing cheaper and fitter" },
          { id: "d", label: "It leaves other industries untouched" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Resource-funded states need not answer" },
          { id: "b", label: "It pushes the government toward democracy" },
          { id: "c", label: "It raises the tax citizens pay" },
          { id: "d", label: "It leaves accountability untouched" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Governance and the rule of law" },
          { id: "b", label: "The sheer volume of resources held" },
          { id: "c", label: "The nation's distance from the coast" },
          { id: "d", label: "The count of resources it exports" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Institutions, not endowments, decide it" },
          { id: "b", label: "That only resources create wealth" },
          { id: "c", label: "That geography alone decides a nation's fate" },
          { id: "d", label: "That institutions do not affect development" },
        ],
        correctChoiceId: "a",
  ...
  },
  {
    ...
    keyTerms: [
      ...
      { label: "Dependency ratio", value: "Dependents per working-age person." },
    ],
    sections: [
      {
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "It shifts slowly and resists reversal" },
          { id: "b", label: "Because populations simply never change" },
          { id: "c", label: "Because policy can reverse it overnight" },
          { id: "d", label: "Because it does not touch the economy" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Educated youth grow; jobless youth revolt" },
          { id: "b", label: "Because the young never affect the economy" },
          { id: "c", label: "Because it always ensures prosperity" },
          { id: "d", label: "Because it invariably causes decline" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Fewer workers strain the pensions" },
          { id: "b", label: "Because the old spend nothing at all" },
          { id: "c", label: "Because it swells the working-age group" },
          { id: "d", label: "Because it carries no fiscal effect" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Dependents per working-age person" },
          { id: "b", label: "The ratio of national debt to GDP" },
          { id: "c", label: "The count of immigrants each year" },
          { id: "d", label: "The balance of exports to imports" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Young jobless areas feed ageing ones" },
          { id: "b", label: "Because migration ignores population" },
          { id: "c", label: "Because ageing regions overflow with workers" },
          { id: "d", label: "Because young populations stay put" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "The depth of a nation's harbours" },
          { id: "b", label: "Room behind the front to absorb a blow" },
          { id: "c", label: "The size of a country's army" },
          { id: "d", label: "The depth of its underground bunkers" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Retreat draws the invader to overextend" },
          { id: "b", label: "The defender drives fast into enemy land" },
          { id: "c", label: "The defender yields all land for good" },
          { id: "d", label: "The defender cedes no ground at all" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Vast distances snapped their supply lines" },
          { id: "b", label: "Because Russia had no land to yield" },
          { id: "c", label: "Because the invaders never advanced" },
          { id: "d", label: "Because Russia surrendered at once" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "No room to retreat from a fast advance" },
          { id: "b", label: "Because small countries are always safe" },
          { id: "c", label: "Because depth matters only to big economies" },
          { id: "d", label: "Because narrow states cannot be attacked" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "To economic depth against blockade" },
          { id: "b", label: "It has fallen wholly obsolete" },
          { id: "c", label: "It now means only missile range" },
          { id: "d", label: "It bears only on naval warfare" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Defence looks like attack, so prudence provokes" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "An aggressor says the same, and intentions do not bind successors" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A secure second strike means striking first gains nothing" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Revisionist states exist; the spiral framing can excuse them" },
