    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "How many turns on average are needed to reach a line from every other line" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Configuration generates movement, which attracts retail, which then amplifies movement" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Unintegrated layouts generate no natural movement, so no one passes through to supervise the space" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It is not uniquely determined, so different analysts can map the same place differently" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It risks recycling the modernist assumption that arranging space correctly produces social outcomes" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Rendering a city as measurable flows, so engineering questions replace aesthetic ones" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A linear metabolism is dependent on continuous extraction by construction, not by inefficiency" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The same element is a depleting mined resource and a pollutant, because urbanisation severed the loop" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Extraction and disposal are relocated outside the boundary rather than reduced" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It can make throughput look like natural necessity rather than contested choices" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "It was a deliberate, historically brief political construction rather than a natural default" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Selectivity — connecting valuable nodes while deliberately not serving what lies between" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Competitors take the cheap-to-serve users, forcing the incumbent to raise prices on the expensive ones" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The universal ideal was a brief Northern norm, so 'splintering' misdescribes places that never had it" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Infrastructure decisions are distributive, so treating them as technical is itself political" },
