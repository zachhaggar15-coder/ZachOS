    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Infinitely many rules fit any finite set of good sentences, yet children learn the limits anyway" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Children never seem to try the simpler linear rule, despite it fitting everything they hear" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The disconfirming complex constructions occur in accessible input more often than claimed" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "They acquire structure-sensitivity from text alone, but on vastly more data than any child receives" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Framing acquisition as induction needing a constrained hypothesis space, whatever supplies the constraint" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Determinism says language constrains what is thinkable; relativity says it influences habitual attention" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Inuit languages are polysynthetic, so counting words is nearly meaningless as a measure" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The difference extends beyond speech into non-linguistic spatial reasoning and memory tasks" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Obligatory marking forces attention on every utterance, whereas optional expression can be ignored" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "English speakers evidently feel it, which is why the borrowed word was adopted so readily" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It showed the exceptions to Grimm's Law were themselves regular, conditioned by PIE accent" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "He posited sounds absent from every known language, and Hittite later showed them written down" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Beyond roughly eight to ten millennia, accumulated change sinks correspondences below chance resemblance" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Kinship, body parts and low numerals resist borrowing, whereas cultural vocabulary travels freely" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Creoles from unrelated sources converge on similar grammar, which coincidence struggles to explain" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Speakers relexified existing substrate grammar with the dominant language's vocabulary" },
