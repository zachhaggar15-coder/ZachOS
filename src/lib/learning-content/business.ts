    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Firms are islands of planning within markets" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "With no theory of high costs, it rationalises anything" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Once the investment is sunk, the other side can squeeze you" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Residual control — deciding what the contract omits" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Firms keep what they are good at, not just costly-to-contract" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Marketing, sales and accounting functions" },
          { id: "b", label: "Create value, deliver it, capture it" },
          { id: "c", label: "Hiring, training and firing staff" },
          { id: "d", label: "Design, manufacturing and shipping goods" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Firms create value they cannot turn into profit" },
          { id: "b", label: "Because capturing value breaks the law" },
          { id: "c", label: "Because capture and creation are one and the same" },
          { id: "d", label: "Because customers refuse to pay for anything" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "To design the product's brand logo" },
          { id: "b", label: "To map a model on one page" },
          { id: "c", label: "To pin down the exact share price" },
          { id: "d", label: "To remove the need for customers entirely" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "That a product must always be sold the same way" },
          { id: "b", label: "Pricing — cheap razor, dear blades — is its own choice" },
          { id: "c", label: "That razors are inherently unprofitable" },
          { id: "d", label: "That subscription pricing never works" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "If serving costs more than they pay, sales lose money" },
          { id: "b", label: "Because popular products are always cheap to build" },
          { id: "c", label: "Because customers resent good products" },
          { id: "d", label: "Because product quality changes nothing" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Why is the firm doing well this one quarter?" },
          { id: "b", label: "Why keep beating rivals who copy you?" },
          { id: "c", label: "How large is the firm's head office?" },
          { id: "d", label: "How many staff the firm employs in total" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Cost leadership or differentiation" },
          { id: "b", label: "Heavy advertising and rapid hiring" },
          { id: "c", label: "Aggressive growth and deliberate shrinkage" },
          { id: "d", label: "Borrowing cheaply and lending dearly" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A durable barrier around profits" },
          { id: "b", label: "A firm's total marketing budget" },
          { id: "c", label: "The physical size of a firm's premises" },
          { id: "d", label: "A short-lived discount on prices" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A cheaply copied edge erases profit" },
          { id: "b", label: "Because copying a rival is always illegal" },
          { id: "c", label: "Because imitation strengthens the first mover" },
          { id: "d", label: "Because advantages are never copied at all" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A sustainable edge is hard to imitate" },
          { id: "b", label: "A temporary advantage always lasts longer" },
          { id: "c", label: "A sustainable advantage needs no effort at all" },
          { id: "d", label: "They are effectively identical in practice" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "The total revenue of the entire company" },
          { id: "b", label: "One unit's revenue and cost" },
          { id: "c", label: "The number of employees in each office" },
          { id: "d", label: "The firm's current share price" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The firm's total profit after tax" },
          { id: "b", label: "A unit's revenue less variable cost" },
          { id: "c", label: "The amount the firm donates to charity" },
          { id: "d", label: "The firm's marketing budget" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Each losing unit deepens the loss" },
          { id: "b", label: "Because growth is inherently harmful" },
          { id: "c", label: "Because customers avoid growing companies" },
          { id: "d", label: "Because extra sales always cut revenue" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Lifetime profit weighed against acquisition cost" },
          { id: "b", label: "It merely measures office rent" },
          { id: "c", label: "It counts the total number of products" },
          { id: "d", label: "It has no bearing at all on profit" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Whether scale fixes or deepens the loss" },
          { id: "b", label: "Whether the company owns a nice logo" },
          { id: "c", label: "Whether growth is always sure to help" },
          { id: "d", label: "Whether to disregard variable costs" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Variable arrivals create clumps that never fully clear" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It rises toward infinity, not gracefully" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It holds for any stable system, whatever the details" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Separate queues strand capacity while others grow" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Idle capacity looks like waste; the queue it prevents is unseen" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Doing as many impressive things as it can" },
          { id: "b", label: "Choosing what not to do" },
          { id: "c", label: "Copying whatever the competitors do" },
          { id: "d", label: "Entering the largest possible number of markets" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Doing the same better just gets copied" },
          { id: "b", label: "Because efficiency simply does not matter" },
          { id: "c", label: "Because strategy means running slower than rivals" },
          { id: "d", label: "Because operational effectiveness is illegal" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Sacrifice to excel elsewhere makes a position defensible" },
          { id: "b", label: "Because a good strategy sacrifices nothing at all" },
          { id: "c", label: "Because trade-offs signal a failing plan" },
          { id: "d", label: "Because they have no effect on competitors" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "No trade-offs means nothing is distinctive" },
          { id: "b", label: "Because offering more always hurts customers" },
          { id: "c", label: "Because customers resent good products" },
          { id: "d", label: "Because it costs too much to advertise" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Activities reinforce one another as a system" },
          { id: "b", label: "That the office layout stays comfortable" },
          { id: "c", label: "That each activity impresses on its own" },
          { id: "d", label: "That the strategy keeps changing constantly" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "The firm's official mission statement" },
          { id: "b", label: "Unspoken norms that shape behaviour" },
          { id: "c", label: "The formal org chart and reporting lines" },
          { id: "d", label: "The firm's annual financial results" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The stated values printed on the poster" },
          { id: "b", label: "The behaviour — what people actually do" },
          { id: "c", label: "Whichever of the two sounds more impressive" },
          { id: "d", label: "Neither, since culture cannot be known" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "By carefully reading the mission statement" },
          { id: "b", label: "By watching what is rewarded" },
          { id: "c", label: "By counting the total number of employees" },
          { id: "d", label: "By studying nothing but the logo" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Visible artifacts like dress code and layout" },
          { id: "b", label: "Assumptions taken for granted" },
          { id: "c", label: "The espoused values hung on the wall" },
          { id: "d", label: "The firm's headline revenue figures" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Good strategy fails if culture fights it" },
          { id: "b", label: "That strategy always outranks culture" },
          { id: "c", label: "That companies ought not to plan" },
          { id: "d", label: "That culture and strategy never interact" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "It prices debt but not equity, so equity looks free" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "One hurdle misprices projects of differing risk" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Without frictions, structure is neutral; debt just shifts risk" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Beta is unstable and the risk premium uncertain" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "A firm produces goods more cheaply at scale" },
          { id: "b", label: "A product improves as more people use it" },
          { id: "c", label: "A firm advertising across many channels" },
          { id: "d", label: "A product whose price falls over time" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Scale cuts cost; networks improve the product" },
          { id: "b", label: "They are precisely the same thing" },
          { id: "c", label: "A network effect merely reduces costs" },
          { id: "d", label: "Scale means users add value for each other" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "When a single user is counted twice" },
          { id: "b", label: "Two linked groups each draw the other" },
          { id: "c", label: "When a product sells in two countries" },
          { id: "d", label: "When a firm is held by two owners" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The biggest network wins, tipping the market" },
          { id: "b", label: "Because regulators demand a single winner" },
          { id: "c", label: "Because small networks always work better" },
          { id: "d", label: "Because users value variety above all else" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Other branches do not help your local one" },
          { id: "b", label: "Because restaurants can hold no advantages" },
          { id: "c", label: "Because scale and network effects are the same" },
          { id: "d", label: "Because restaurant chains never grow" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Only within government organisations" },
          { id: "b", label: "A hired agent's interests differ and hide" },
          { id: "c", label: "Only where the agent is dishonest" },
          { id: "d", label: "Only inside very large companies" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The agent knows their effort; the principal cannot" },
          { id: "b", label: "Both parties hold exactly the same information" },
          { id: "c", label: "The principal always knows more than their agent" },
          { id: "d", label: "Information freely available to everyone" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Hidden shirking after the deal" },
          { id: "b", label: "The principal deceiving the agent" },
          { id: "c", label: "A morally admirable outcome" },
          { id: "d", label: "Information disclosed before a deal" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Agents chase whatever the price rewards" },
          { id: "b", label: "Because company shares hold no value" },
          { id: "c", label: "Because executives disregard all incentives" },
          { id: "d", label: "Because alignment is forever impossible" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Self-interest losses plus monitoring cost" },
          { id: "b", label: "The fee a recruitment agency charges" },
          { id: "c", label: "The combined salary of every employee" },
          { id: "d", label: "The firm's total cost of advertising" },
        ],
        correctChoiceId: "a",
