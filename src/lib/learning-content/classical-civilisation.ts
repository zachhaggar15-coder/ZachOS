    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Whether the poems were stitched from older lays or built by a single designing poet" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Extensive metrical coverage with almost no duplication — too economical to be one poet's style" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Singers composed in performance from formulas, producing variable versions they believed identical" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A composing singer holds no fixed text in mind, so distant details are not reconciled" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Internal faction escalating along a continuum to civil violence" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "As a recurring pathology with a describable course rather than a moral failure" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Once restraint can only be described as cowardice, moderates are disarmed before they speak" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Generational decay — those who won the constitution value it, their heirs do not" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Institutions hold through counterposed interests rather than the virtue of their occupants" },
