    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Viewers bring historically specific skills learned elsewhere, which determine what they can read" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It drilled merchants in analysing three-dimensional form into geometric components" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It is differently equipped and, in specific respects, less competent than the original audience's" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Scholarship restores what is there rather than mediating a direct encounter" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Circularity — the period eye is partly inferred from the pictures it then explains" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "It is a culturally specific scheme for organising experience, like a language or a myth" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It requires a fixed monocular eye and flat field, whereas vision is binocular, mobile and curved" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Hierarchical scaling encodes a claim about importance, not an error about optics" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A single beholder at the origin, with the world spread out for one observer's inspection" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Perspective is a good approximation under specific conditions; what is ideological is its promotion to truth" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The fiction that she is not performing is what the spectator wants, so she performs unawareness" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A woman internalising the watching position and applying it to herself continually" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It is heteronormative and treats audiences as passive, ignoring oppositional reading" },
