...
const economics: AuthoredLesson[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Hidden action after the contract, versus hidden information before it" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Low risks take the high-deductible policy; high risks avoid it" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A higher rate selects for riskier borrowers, worsening the pool" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Discounting is exponential, so any positive rate erases distant weight" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Pure time preference — discounting welfare for being future" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Your present self constrains a future self it knows will differ" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Coping with knowledge that is never given to anyone in full" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It compresses the system's whole state into a single number" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The needed knowledge is tacit and generated only by competing" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The price omits a real cost, so everyone coordinates on a wrong signal" },
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "To judge the whole stock, not the increment" },
          { id: "b", label: "Weigh the benefit and cost of one more unit" },
          { id: "c", label: "To act only when the total benefit is positive" },
          { id: "d", label: "To commit fully to a course once it is chosen" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Act while marginal benefit exceeds marginal cost" },
          { id: "b", label: "Do as much as the available budget will fund" },
          { id: "c", label: "Do more whenever the average benefit is positive" },
          { id: "d", label: "Do more until the total benefit stops rising" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Each unit is worth less, until it fails to cover cost" },
          { id: "b", label: "Because balanced choices signal good judgement to others" },
          { id: "c", label: "Because the cost of each unit falls as you do more" },
          { id: "d", label: "Because total benefit is maximised at the midpoint" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The extra unit's own cost is what matters here" },
          { id: "b", label: "Because average cost includes fixed costs already paid" },
          { id: "c", label: "Because the average falls automatically as output grows" },
          { id: "d", label: "Because the order price must cover the full average cost" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It weighs only the next unit's future benefit and cost" },
          { id: "b", label: "Because sunk costs are recovered once output is sold" },
          { id: "c", label: "Because past spending raises the value of continuing" },
          { id: "d", label: "Because sunk costs are counted in the average instead" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "A cost or benefit on someone outside the trade" },
          { id: "b", label: "A cost the seller passes on to the buyer in the price" },
          { id: "c", label: "A charge a government adds to a harmful transaction" },
          { id: "d", label: "A benefit the buyer receives beyond what they paid" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Producers ignore the social cost, so output is too high" },
          { id: "b", label: "Because producers over-invest in avoiding all pollution" },
          { id: "c", label: "Because the social cost is lower than the private cost" },
          { id: "d", label: "Because polluters overstate the harm they actually cause" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Each captures only private benefit, ignoring the spillover" },
          { id: "b", label: "Because the private benefit exceeds the social benefit" },
          { id: "c", label: "Because producers capture the full social benefit already" },
          { id: "d", label: "Because the spillover benefit raises private demand too far" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A charge levied on every good at a single flat rate" },
          { id: "b", label: "A tax equal to the external cost of the activity" },
          { id: "c", label: "A refund paid to firms that reduce their emissions" },
          { id: "d", label: "A cap on the total quantity a firm may produce" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The exact size of a spillover is hard to measure" },
          { id: "b", label: "The theory applies only to pollution, not other spillovers" },
          { id: "c", label: "Correcting one spillover always creates a larger one" },
          { id: "d", label: "Markets remove all spillovers without any intervention" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "The direction in which quantity moves when price changes" },
          { id: "b", label: "The size of the quantity response to a change in price" },
          { id: "c", label: "The share of income a household spends on the good" },
          { id: "d", label: "The speed at which a price change reaches the market" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Elastic demand responds strongly; inelastic barely" },
          { id: "b", label: "Elastic demand applies to luxuries; inelastic to necessities" },
          { id: "c", label: "They are the same" },
          { id: "d", label: "Elastic demand rises over time; inelastic demand falls" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "One brand has close substitutes; coffee in general has few" },
          { id: "b", label: "Because a single brand is usually cheaper than the category" },
          { id: "c", label: "Because brand loyalty makes buyers less price-sensitive" },
          { id: "d", label: "Because a brand is bought more often than the category" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Revenue rises: few sales lost, and each earns more" },
          { id: "b", label: "Revenue falls, as lost sales outweigh the higher price" },
          { id: "c", label: "Revenue is unchanged, since quantity and price offset" },
          { id: "d", label: "Revenue falls only if the good has close substitutes" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Revenue needs inelastic demand; behaviour change needs elastic" },
          { id: "b", label: "Because the tax burden always falls on the producer" },
          { id: "c", label: "Because revenue and behaviour both need elastic demand" },
          { id: "d", label: "Because elastic goods cannot legally be taxed at all" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Being better in raw terms, versus a lower opportunity cost" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "It should trade only for goods it physically cannot make" },
          { id: "b", label: "Both still gain by specialising on comparative advantage" },
          { id: "c", label: "Trade benefits only the party with fewer resources" },
          { id: "d", label: "Gains go entirely to the more productive party" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Her opportunity cost of typing is the law forgone" },
          { id: "b", label: "Because the secretary has an absolute advantage in typing" },
          { id: "c", label: "Because her typing speed falls over a long working day" },
          { id: "d", label: "Because delegating low-value tasks signals seniority" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Opportunity costs are relative, so each is least-cost somewhere" },
          { id: "b", label: "Because absolute advantage is shared evenly across tasks" },
          { id: "c", label: "Because trade agreements guarantee each a specialism" },
          { id: "d", label: "Because every producer has some absolute advantage" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Trade raises total gains but does not share them fairly" },
          { id: "b", label: "That total output falls whenever a country specialises" },
          { id: "c", label: "That the gains always favour the larger economy" },
          { id: "d", label: "That absolute advantage still determines who trades" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Contests decided purely by chance rather than skill" },
          { id: "b", label: "Situations where each outcome depends on others' choices" },
          { id: "c", label: "Choices where one actor's payoff is fixed in advance" },
          { id: "d", label: "Markets in which no participant can affect the price" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "The outcome that maximises the players' combined payoff" },
          { id: "b", label: "A strategy set where no one gains by deviating alone" },
          { id: "c", label: "A point reached only when players can communicate freely" },
          { id: "d", label: "The strategy that guarantees a win whatever others do" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Confessing is dominant, though silence would beat it" },
          { id: "b", label: "Because the two can coordinate on staying silent" },
          { id: "c", label: "Because confessing shortens the sentence in every case jointly" },
          { id: "d", label: "Because silence is dominant but they fail to see it" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Individually rational choices can leave everyone worse off" },
          { id: "b", label: "That rational players always reach the best joint outcome" },
          { id: "c", label: "That communication alone guarantees cooperation" },
          { id: "d", label: "That the worst outcome is always the most likely one" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Repeated play lets betrayal be punished in later rounds" },
          { id: "b", label: "Because repetition makes the payoffs shrink each round" },
          { id: "c", label: "Because players forget earlier betrayals over time" },
          { id: "d", label: "Because a fixed end date strengthens cooperation" },
        ],
        correctChoiceId: "a",
    ...
    questions: [
      {
        ...
        choices: [
          { id: "a", label: "Valued by the public and provided at low cost" },
          { id: "b", label: "Non-excludable and non-rival at the same time" },
          { id: "c", label: "Expensive to produce but cheap for each person to use" },
          { id: "d", label: "Rival in use but impossible to charge anyone for" },
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "People use it without paying, so markets underprovide it" },
          { id: "b", label: "People overuse a good because it feels free to them" },
          { id: "c", label: "Firms provide the good but cannot cover their costs" },
          { id: "d", label: "Users free-ride, so the good is over-supplied instead" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Markets charge users, but non-payers cannot be excluded" },
          { id: "b", label: "Because public goods cost more than any firm can raise" },
          { id: "c", label: "Because demand for public goods cannot be measured" },
          { id: "d", label: "Because public goods wear out too fast to sell" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Taxation is compulsory, so no one can free-ride" },
          { id: "b", label: "Taxation lets the state charge each user directly" },
          { id: "c", label: "Taxation shifts provision to private firms instead" },
          { id: "d", label: "Taxation works only for goods that are excludable" },
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "A resource that is excludable but shared without rivalry" },
          { id: "b", label: "A rival, non-excludable resource users deplete" },
          { id: "c", label: "A public good that costs nothing to maintain" },
          { id: "d", label: "A non-rival resource that markets always oversupply" },
        ],
        correctChoiceId: "b",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Equilibrium outcomes of the regime, void once policy changes it" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Forecast errors are not systematically biased, since they get learned away" },
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: "Anticipated policy is priced in, so output does not move" },
